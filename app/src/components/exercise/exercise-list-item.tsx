...
export const ExerciseListItem: React.FC<ExerciseListItem> = (props) => {
    ...
    return (
        <IonItem detail={props.noDetail ? false : true} mode='ios' onClick={props.selectionMode ? undefined : props.onClick} routerDirection='forward' routerLink={props.selectionMode || props.noDetail ? undefined : `/exercise/details/${ex._id}`} button={!props.selectionMode} style={props.style} lines='none' className='exercise-list-item'>
