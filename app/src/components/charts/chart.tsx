            ...
            <div className='segment-container'>
                <IonSegment onIonChange={(e) => { SetDuration(e.detail.value as ChartDuration) }} value={duration} mode='ios'>
                    ...
                    <IonSegmentButton value='6m'>
                        <IonText><IonIcon icon={lockClosed} style={{ fontSize: 10 }} />6M</IonText>
                    </IonSegmentButton>
                    <IonSegmentButton value='1y'>
                        <IonText><IonIcon icon={lockClosed} style={{ fontSize: 10 }} />1Y</IonText>
                    </IonSegmentButton>
                    <IonSegmentButton value='L'>
                        <IonText><IonIcon style={{ fontSize: 10 }} icon={lockClosed} /> Lifetime</IonText>
                    </IonSegmentButton>
                </IonSegment>
            </div>
