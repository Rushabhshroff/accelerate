import { IonButton, IonButtons, IonContent, IonFab, IonFabButton, IonIcon, IonLabel, IonPage, IonSegment, IonSegmentButton, IonTitle, isPlatform, useIonModal } from '@ionic/react'
