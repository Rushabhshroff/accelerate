                    ...
                    <div >
                        <div >
                            <div>
                                ...
                                <h1>Privacy Policy of <strong>Accelerate</strong></h1>
                                            ...
                                            <li>
                                                ...
                                                <div >
                                                    ...
                                                    <ul >
                                                        ...
                                                        <li>
                                                            <h3>TestFlight</h3>
                                                            <p>Personal Data: various types of Data as specified in the privacy
                                                ...
                                                <div>
                                                    ...
                                                    <ul >
                                                        ...
                                                        <li>
                                                            ...
                                                            <p>Personal Data: general activity data</p>
                                                        </li>
                                            ...
                                            <li>
                                                ...
                                                <div >
                                                    ...
                                                    <ul >
                                                        ...
                                                        <li>
                                                            <h3>Payments processed via the Apple App Store and Payments processed
                                                            via the Google Play
                                                    Store</h3>
                                                ...
                                                <div >
                                                    ...
                                                    <ul >
                                                        ...
                                                        <li>
                                                            ...
                                                            <p>Personal Data: email address; first name; last name; password; gender; address;</p>
                                                        </li>
                                                ...
                                                <div >
                                                    ...
                                                    <ul >
                                                        ...
                                                        <li>
                                                            ...
                                                            <p>Personal Data: first name; username</p>
                                                        </li>
                                        ...
                                        <ul >
                                            <li>
                                                <div >
                                                    ...
                                                    <p>Accelerate Fitness L.L.P.
                                            <br />
                                                        <br />Mumbai-400004
                                            <br />India
                                        </p>
                                                    <p><strong>Contact email:</strong> support@accelerate.fitness</p>
                                                </div>
                                            </li>
                                        </ul>
                                    </li>
                        ...
                        <br />India
                                ...
                                <p><b>Contact email:</b> support@accelerate.fitness</p>
                            </div>
                            ...
                            <div >
                                ...
                                <p>
                                    ...
                                    parties, there
                                    are:
                                    Cookies; Usage Data; first name; username; various types of Data; email address; password;
                                    general
                        ...
                        may be freely provided by the User, or, in case of Usage Data, collected automatically when
                        using this
                        Application.<br />Unless specified otherwise, all Data requested by this Application is
                        mandatory and
                        ...
                        modification, or unauthorized destruction of the Data.<br />The Data processing is carried out using computers
                        and/or IT enabled tools, following organizational procedures and modes strictly related to the purposes indicated.
                        In addition to the Owner, in some cases, the Data may be accessible to certain types of persons
                        in charge, involved with the operation of this Application (administration, sales, marketing, legal, system
                        ...
                        Processors by the Owner. The updated list of these parties may be requested from the Owner at any time.</p>
                                ...
                                <ul>
                                    ...
                                    legislations the
                                    Owner may be allowed to process Personal Data until the User objects to such processing
                                    (“opt-out”),
                        ...
                        country
                        other than their own. To find out more about the place of processing of such transferred Data,
                        Users can
                        check the section containing details about the processing of Personal Data.</p>
                        ...
                        collected for.</p>
                            ...
                            the User shall be retained until such contract has been fully performed.</li>
                                    ...
                                    retained as long
                                    as needed to fulfill such purposes. Users may find specific information regarding the
                                    legitimate
                                    interests pursued by the Owner within the relevant sections of this document or by
                                    contacting the Owner.
                        </li>
                                </ul>
                                <p>The Owner may be allowed to retain Personal Data for a longer period whenever the User has given
                                consent
                                to such processing, as long as such consent is not withdrawn. Furthermore, the Owner may be
                                obliged to
                                retain Personal Data for a longer period whenever required to do so for the performance of a
                                legal
                        obligation or upon order of an authority.<br /><br />
                        Once the retention period expires, Personal Data shall be deleted. Therefore, the right to
                        access, the
                        right to erasure, the right to rectification and the right to data portability cannot be
                        enforced after
                        expiration of the retention period.</p>
                            ...
                            <div >
                                ...
                                <p>
                                    ...
                                    its legal
                                    obligations, respond to enforcement requests, protect its rights and interests (or those of its
                                    Users or
                                    third parties), detect any malicious or fraudulent activity, as well as the following:
                                    Analytics, Beta Testing, Social features, Content commenting, Registration and authentication,
                                    Handling
                                    activity data, Access to third-party accounts, Platform services and hosting and Handling
                                    payments.
                    </p>
                        ...
                        “Detailed information on the processing of Personal Data”.</p>
                            ...
                            <div >
                                ...
                                <ul >
                                    ...
                                    <li>
                                        <div >
                                            <h3 >Access to third-party
                                    accounts</h3>
                                            <div >
                                                <p>This type of service allows this Application to access Data from your account on
                                                a third-party
                                        service and perform actions with it.<br />
                                        ...
                                        authorization by the User.
                                                ...
                                                <div >
                                                    <p>This service allows this Application to connect with the User's account on
                                                    the Facebook social
                                            network, provided by Facebook, Inc.</p>
                                                </div>
                                    ...
                                    <li>
                                        <div >
                                            <h3 >Analytics</h3>
                                            <div >
                                                <p>The services contained in this section enable the Owner to monitor and analyze
                                                web traffic and
                                        can be used to keep track of User behavior.</p>
                                                <h4>Amplitude (Sonalight, Inc.)</h4>
                                                <div >
                                                    <p>Amplitude is an analytics service provided by Sonalight, Inc.<br />
                                            This service is designed for mobile apps analytics and can collect various
                                            information about
                                            your phone, highlighted in the Amplitude privacy policy.</p>
                                                </div>
                                        ...
                                        <a href="https://amplitude.com/privacy" target="_blank"
                                            ...
                                            Policy</a>.
                                                ...
                                                <div >
                                                    ...
                                                    provided by Google
                                            LLC.<br />
                                                        <strong>In order to understand Google's use of Data, consult <a
                                                            href="https://www.google.com/policies/privacy/partners/">Google's
                                                            partner
                                                    policy</a></strong>.
                                        </p>

                                                    <p>Firebase Analytics may share Data with other tools provided by Firebase, such
                                                    as Crash
                                                    Reporting, Authentication, Remote Config or Notifications. The User may
                                                    check this privacy
                                                    policy to find a detailed explanation about the other tools used by the
                                            Owner.</p>

                                                    <p>This Application uses identifiers for mobile devices and technologies similar
                                                    to cookies to run
                                            the Firebase Analytics service.</p>

                                                    <p>Users may opt-out of certain Firebase features through applicable device
                                                    settings, such as the
                                                    device advertising settings for mobile phones or by following the
                                                    instructions in other Firebase
                                            related sections of this privacy policy, if available.</p>
                                                </div>
                                    ...
                                    <li>
                                        <div >
                                            <h3 >Beta Testing</h3>
                                            <div >
                                                <p>This type of service makes it possible to manage User access to this Application,
                                                or parts of it,
                                        for the purpose of testing a certain feature or the entire Application.<br />
                                        The service provider may automatically collect data related to crashes and
                                        statistics related to
                                        the User's use of this Application in a personally identifiable form.</p>
                                                ...
                                                <p>Personal Data processed: various types of Data as specified in the privacy policy
                                                of the service.
                                    </p>
                                                <p>Place of processing:
                                                United States
                                    ...
                                    <li>
                                        <div >
                                            <h3 >Content commenting</h3>
                                            <div >
                                                <p>Content commenting services allow Users to make and publish their comments on the
                                                contents of
                                        this Application.<br />
                                        Depending on the settings chosen by the Owner, Users may also leave anonymous
                                        comments. If there
                                        is an email address among the Personal Data provided by the User, it may be used
                                        to send
                                        notifications of comments on the same content. Users are responsible for the
                                        content of their own
                                        comments.<br />
                                        If a content commenting service provided by third parties is installed, it may
                                        still collect web
                                        traffic data for the pages where the comment service is installed, even when
                                        Users do not use the
                                        content commenting service.</p>
                                    ...
                                    <li>
                                        <div >
                                            <h3 >Handling activity data
                                </h3>
                                            <div >
                                                <p>This type of service allows the Owner to use the activity data collected by your
                                                device in order
                                                for this Application to operate or to provide specific features. This may
                                                include movements,
                                        heartbeat, change in altitude or data about the surroundings.<br />
                                        Depending on what is described below, third parties may be involved in the
                                        activity
                                        tracking.<br />
                                        Most devices allow for the User to control which Data is accessed or stored.</p>


                                                <h4>Apple HealthKit (Apple Inc.)</h4>
                                                <div >
                                                    <p>HealthKit is an activity data handling service provided by Apple Inc. that
                                                    enables the Owner to
                                            access or store activity data.</p>
                                                </div>
                                    ...
                                    <li>
                                        <div >
                                            <h3 >Handling payments</h3>
                                            <div >
                                                <p>Unless otherwise specified, this Application processes any payments by credit
                                                card, bank transfer
                                                or other means via external payment service providers. In general and unless
                                                where otherwise
                                                stated, Users are requested to provide their payment details and personal
                                                information directly to
                                                such payment service providers. This Application isn't involved in the
                                                collection and processing
                                                of such information: instead, it will only receive a notification by the
                                                relevant payment service
                                        provider as to whether payment has been successfully completed.</p>


                                                <h4>Payments processed via the Apple App Store (Apple Inc.)</h4>
                                                <div >
                                                    <p>This Application uses a payment service provided by Apple Inc. that allows
                                                    the Owner to offer
                                            the purchase of the app itself or in-app purchases.</p>

                                                    <p>Personal Data processed to complete the purchases are processed by Apple, as
                                                    described in the
                                            <a href="https://www.apple.com/legal/privacy/en-ww/">privacy policy for the
                                                App Store</a>.
                                        </p>
                                                </div>
                                        ...
                                        <a href="https://www.apple.com/legal/privacy/en-ww/" target="_blank"
                                                ...
                                                <h4>Payments processed via the Google Play Store (Google Ireland Limited)</h4>
                                                <div >
                                                    <p>This Application uses a payment service provided by Google Ireland Limited
                                                    that allows the
                                            Owner to offer the purchase of the app itself or in-app purchases.</p>

                                                    <p>Personal Data processed to complete the purchases are processed by Google, as
                                                    described in the
                                            <a href="https://policies.google.com/privacy?hl=en&amp;gl=it">privacy policy
                                                        for the Google Play
                                                store</a>.
                                        </p>
                                                </div>
                                    ...
                                    <li>
                                        <div >
                                            <h3 >Platform services and
                                    hosting</h3>
                                            <div >
                                                <p>These services have the purpose of hosting and running key components of this
                                                Application,
                                                therefore allowing the provision of this Application from within a unified
                                                platform. Such
                                                platforms provide a wide range of tools to the Owner – e.g. analytics, user
                                                registration,
                                                commenting, database management, e-commerce, payment processing – that imply the
                                                collection and
                                        handling of Personal Data. <br />
                                        Some of these services work through geographically distributed servers, making
                                        it difficult to
                                        determine the actual location where the Personal Data are stored.</p>
                                            ...
                                            apps, provided by Apple Inc.</p>

                                                    <p>By virtue of being distributed via this app store, Apple collects basic
                                                    analytics and provides
                                                    reporting features that enables the Owner to view usage analytics data and
                                                    measure the
                                                    performance of this Application. Much of this information is processed on an
                                            opt-in basis.</p>

                                                    <p>Users may opt-out of this analytics feature directly through their device
                                                    settings. More
                                            information on how to manage analysis settings can be found on <a
                                                            href="https://support.apple.com/en-us/HT202100">this page</a>.</p>
                                                </div>
                                        ...
                                        <a href="https://www.apple.com/legal/privacy/" target="_blank"
                                            ...
                                            Policy</a>.
                                                ...
                                                <div >
                                                    <p>This Application is distributed on the Google Play Store, a platform for the
                                                    distribution of
                                            mobile apps, provided by Google LLC.</p>

                                                    <p>By virtue of being distributed via this app store, Google collects usage and
                                                    diagnostics data
                                                    and share aggregate information with the Owner. Much of this information is
                                                    processed on an
                                            opt-in basis.</p>
                                                    ...
                                                    settings. More
                                            information on how to manage analysis settings can be found on <a
                                                            href="https://support.google.com/accounts/answer/6078260">this page</a>.
                                        </p>
                                                </div>
                                    ...
                                    authentication</h3>
                                            <div >
                                                <p>By registering or authenticating, Users allow this Application to identify them
                                                and give them
                                        access to dedicated services.<br />
                                        Depending on what is described below, third parties may provide registration and
                                        authentication
                                        services. In this case, this Application will be able to access some Data,
                                        stored by these
                                        third-party services, for registration or identification purposes.</p>


                                                <h4>Direct registration (this Application)</h4>
                                                <div >
                                                    <p>The User registers by filling out the registration form and providing the
                                                    Personal Data
                                            directly to this Application.</p>
                                                </div>

                                                <p>Personal Data processed: email address; first name; password; username.</p>
                                    ...
                                    <li>
                                        <div >
                                            ...
                                            <div >
                                                ...
                                                <h4>Public profile (this Application)</h4>
                                                <div >
                                                    <p>Users may have public profiles that other Users can display. In addition to
                                                    the Personal Data
                                                    provided, this profile may contain Users' interactions with this
                                            Application.</p>
                                                </div>

                                                <p>Personal Data processed: first name; username.</p>
                                                ...
                                                <h4>Inviting and suggesting friends (this Application)</h4>
                                                <div >
                                                    <p>This Application may use the Personal Data provided to allow Users to invite
                                                    their friends -
                                                    for example through the address book, if access has been provided - and to
                                                    suggest friends or
                                            connections inside it.</p>
                                                </div>
                            ...
                            are provided
                            in the dedicated section below.</li>
                            ...
                            based on
                            the User's consent, on a contract which the User is part of or on pre-contractual
                            obligations thereof.
                        </li>
                            ...
                            authority.</li>
                                ...
                                vested
                                in the Owner or for the purposes of the legitimate interests pursued by the Owner, Users may
                                object to
                        ...
                        of this document. </p>
                                ...
                                provided in
                                this document. These requests can be exercised free of charge and will be addressed by the Owner
                                as early
                        as possible and always within one month.</p>
                            </div>

                            <div >

                                <h2 id="further_data_processing_info">Additional information about Data collection and processing
                    </h2>
                                <h3>Legal action</h3>
                        ...
                        Services.<br />The User
                        declares to be aware that the Owner may be required to reveal personal data upon request of
                        public
                        authorities.</p>
                                ...
                                processing
                        of Personal Data upon request.</p>
                                <h3>System logs and maintenance</h3>
                                <p>For operation and maintenance purposes, this Application and any third-party services may collect
                                files
                                that record interaction with this Application (System logs) use other Personal Data (such as the
                                IP
                        Address) for this purpose.</p>
                                ...
                                Owner at
                        any time. Please see the contact information at the beginning of this document.</p>
                        ...
                        policies.</p>
                                ...
                                Users on
                                this page and possibly within this Application and/or - as far as technically and legally
                                feasible -
                            ...
                            <div >
                                <div >
                                    ...
                                    <div >
                                        ...
                                        utilized by
                                        the Users who use this Application, the URI addresses (Uniform Resource Identifier), the
                                        time of the
                                        request, the method utilized to submit the request to the server, the size of the file
                                        received in
                                        response, the numerical code indicating the status of the server's answer (successful
                                        outcome, error,
                                        etc.), the country of origin, the features of the browser and the operating system
                                        utilized by the
                                        ...
                                        the sequence
                                        of pages visited, and other parameters about the device operating system and/or the
                                        User's IT
                                environment.</p>
                                ...
                                behalf of the Controller, as described in this privacy policy.</p>
                                        ...
                                        jointly with
                                        others, determines the purposes and means of the processing of Personal Data, including
                                        the security
                                        measures concerning the operation and use of this Application. The Data Controller,
                                        unless otherwise
                                ...
                                all current member states to the European Union and the European Economic Area.</p>
                                        ...
                                        scripts,
                                        e-tags and fingerprinting - that enables the tracking of Users, for example by accessing
                                        or storing
                                information on the User’s device.</p>
                                        ...
                                        including Art.
                                13/14 of Regulation (EU) 2016/679 (General Data Protection Regulation).</p>
